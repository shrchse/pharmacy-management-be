...
--   npx prisma db execute --file prisma/seed.mvp1.sql
--
-- Demo login:
--   superadmin@apotek-mvp1.local / Password123!
--   owner@apotek-mvp1.local      / Password123!
--   admin@apotek-mvp1.local      / Password123!
--   apj@apotek-mvp1.local        / Password123!  APJ PIN: 123456
--   cashier@apotek-mvp1.local    / Password123!
...
WHERE "code" IN ('product.manage', 'stock.read', 'stock.adjust', 'purchase.manage', 'compliance.manage', 'report.read')
ON CONFLICT ("roleId", "permissionId") DO NOTHING;
...
INSERT INTO "User" (
  ...
  ('33000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '32000000-0000-4000-8000-000000000001', 'Owner MVP 1', 'owner@apotek-mvp1.local', '081100000001', '$2b$10$93UIDoXKup.A8RyW1xgxsOOFP57sTgGfdQe53mLXguvueZctFCoHq', '$2b$10$EHtxeYmJyXqOyqpypXfOAeIAv1oVL1qrjoG3H47uvS6Nw83IacvUy', 'SIPA-OWNER-MVP1', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('33000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '32000000-0000-4000-8000-000000000002', 'Apt. Andini Rahma', 'apj@apotek-mvp1.local', '081100000002', '$2b$10$93UIDoXKup.A8RyW1xgxsOOFP57sTgGfdQe53mLXguvueZctFCoHq', '$2b$10$EHtxeYmJyXqOyqpypXfOAeIAv1oVL1qrjoG3H47uvS6Nw83IacvUy', 'SIPA-MVP1-001', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('33000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '32000000-0000-4000-8000-000000000003', 'Kasir MVP 1', 'cashier@apotek-mvp1.local', '081100000003', '$2b$10$93UIDoXKup.A8RyW1xgxsOOFP57sTgGfdQe53mLXguvueZctFCoHq', NULL, NULL, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('33000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '32000000-0000-4000-8000-000000000004', 'Admin Cabang MVP 1', 'admin@apotek-mvp1.local', '081100000004', '$2b$10$93UIDoXKup.A8RyW1xgxsOOFP57sTgGfdQe53mLXguvueZctFCoHq', NULL, NULL, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('33000000-0000-4000-8000-000000000005', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '32000000-0000-4000-8000-000000000005', 'Super Admin MVP 1', 'superadmin@apotek-mvp1.local', '081100000005', '$2b$10$93UIDoXKup.A8RyW1xgxsOOFP57sTgGfdQe53mLXguvueZctFCoHq', NULL, NULL, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
INSERT INTO "Sale" (
  ...
  ('73000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', 'INV-SEED-REG-001', 'OFFLINE', '72000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000003', '70000000-0000-4000-8000-000000000001', 'REGULAR', 'COMPLETED', 'PAID', 80000, 2000, 0, 78000, 80000, 2000, '/receipts/INV-SEED-REG-001.pdf', CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP),
  ('73000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', 'INV-SEED-CR-001', 'OFFLINE', '72000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000003', '70000000-0000-4000-8000-000000000002', 'REGULAR', 'COMPLETED', 'UNPAID', 150000, 0, 0, 150000, 0, 0, NULL, NULL, CURRENT_TIMESTAMP - INTERVAL '5 days', CURRENT_TIMESTAMP),
  ('73000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', 'INV-SEED-RX-001', 'OFFLINE', '72000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000003', '70000000-0000-4000-8000-000000000001', 'PRESCRIPTION', 'COMPLETED', 'PAID', 49000, 0, 0, 49000, 50000, 1000, '/receipts/INV-SEED-RX-001.pdf', CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP)
...
INSERT INTO "Prescription" (
  ...
  ('74000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '73000000-0000-4000-8000-000000000003', 'RX-SEED-REDEEMED-001', 'MANUAL', 'REDEEMED', 'NONE', NULL, 1, '71000000-0000-4000-8000-000000000001', '70000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000002', NULL, 'Seed prescription already dispensed', CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP - INTERVAL '2 days')
...
INSERT INTO "Purchase" (
  ...
  ('76000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', 'PO-SEED-RECV-001', 'INV-PBF-SEED-001', 'RECEIVED', '50000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000002', 900000, 0, 99000, 999000, CURRENT_TIMESTAMP - INTERVAL '3 days', CURRENT_TIMESTAMP - INTERVAL '20 days', CURRENT_TIMESTAMP - INTERVAL '21 days', CURRENT_TIMESTAMP),
  ('76000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', 'PO-SEED-DRAFT-001', NULL, 'DRAFT', '50000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000002', 150000, 0, 16500, 166500, CURRENT_TIMESTAMP + INTERVAL '14 days', NULL, CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP)
...
INSERT INTO "PurchaseApproval" (
  ...
  ('76200000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '76000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000003', '33000000-0000-4000-8000-000000000002', 'APPROVED', 'Seed received PO approval', CURRENT_TIMESTAMP - INTERVAL '20 days', NULL, CURRENT_TIMESTAMP - INTERVAL '21 days'),
  ('76200000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '76000000-0000-4000-8000-000000000002', '33000000-0000-4000-8000-000000000003', NULL, 'PENDING', 'Seed pending approval', NULL, NULL, CURRENT_TIMESTAMP - INTERVAL '1 day')
ON CONFLICT ("id") DO UPDATE SET
...
INSERT INTO "CashMutation" (
  ...
  ('79100000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '79000000-0000-4000-8000-000000000001', 'OPENING_BALANCE', 1500000, 'Seed', NULL, 'Saldo awal seed', '33000000-0000-4000-8000-000000000001', CURRENT_TIMESTAMP),
  ('79100000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '79000000-0000-4000-8000-000000000001', 'SALE_PAYMENT', 78000, 'Sale', '73000000-0000-4000-8000-000000000001', 'Pembayaran sale seed', '33000000-0000-4000-8000-000000000003', CURRENT_TIMESTAMP - INTERVAL '1 day'),
  ('79100000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000001', NULL, '79000000-0000-4000-8000-000000000002', 'DEBT_PAYMENT', 250000, 'Debt', '77000000-0000-4000-8000-000000000001', 'Pembayaran hutang supplier seed', '33000000-0000-4000-8000-000000000001', CURRENT_TIMESTAMP - INTERVAL '4 days')
ON CONFLICT ("id") DO UPDATE SET
  "amount" = EXCLUDED."amount",
...
INSERT INTO "StockLedger" (
  ...
  ('83000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '60000000-0000-4000-8000-000000000001', '63000000-0000-4000-8000-000000000001', '62000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000002', 'PURCHASE', 1000, 140, 'Purchase', '76000000-0000-4000-8000-000000000001', 'PO-SEED-RECV-001', 'Pembelian seed', CURRENT_TIMESTAMP - INTERVAL '20 days'),
  ('83000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '60000000-0000-4000-8000-000000000001', '63000000-0000-4000-8000-000000000001', '62000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000003', 'SALE', -20, 120, 'Sale', '73000000-0000-4000-8000-000000000001', 'INV-SEED-REG-001', 'Penjualan seed', CURRENT_TIMESTAMP - INTERVAL '1 day'),
  ('83000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '60000000-0000-4000-8000-000000000002', '63000000-0000-4000-8000-000000000002', '62000000-0000-4000-8000-000000000002', '33000000-0000-4000-8000-000000000003', 'SALE', -10, 24, 'Prescription', '74000000-0000-4000-8000-000000000002', 'INV-SEED-RX-001', 'Dispense resep seed', CURRENT_TIMESTAMP - INTERVAL '2 days')
ON CONFLICT ("id") DO UPDATE SET
...
INSERT INTO "EmployeeProfile" (
  ...
  ('89000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000002', 'EMP-APJ-001', 'Apoteker Penanggung Jawab', DATE '2025-01-01', 7500000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('89000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '33000000-0000-4000-8000-000000000003', 'EMP-CASHIER-001', 'Kasir', DATE '2025-02-01', 4500000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
INSERT INTO "AuditLog" (
  ...
  ('94000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '33000000-0000-4000-8000-000000000001', 'CREATE', 'Seed', '20000000-0000-4000-8000-000000000001', NULL, '{"status":"seeded"}'::jsonb, '{"script":"prisma/seed.mvp1.sql"}'::jsonb, '127.0.0.1', 'SQL seed', CURRENT_TIMESTAMP),
  ('94000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000011', '33000000-0000-4000-8000-000000000003', 'LOGIN', 'User', '33000000-0000-4000-8000-000000000003', NULL, '{"email":"cashier@apotek-mvp1.local"}'::jsonb, '{"source":"seed"}'::jsonb, '127.0.0.1', 'SQL seed', CURRENT_TIMESTAMP)
ON CONFLICT ("id") DO UPDATE SET
